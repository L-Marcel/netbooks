...
INSERT IGNORE INTO payment (subscription, price, pay_date, due_date, status) VALUES
  ...
  (1, 12.00, DATE_ADD(CURRENT_DATE, INTERVAL 23 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 30 DAY), 'SCHEDULED'),
  (2, 30.00, DATE_ADD(CURRENT_DATE, INTERVAL 23 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 30 DAY), 'SCHEDULED'),
  (3, 300.00, DATE_ADD(CURRENT_DATE, INTERVAL 358 DAY), DATE_ADD(CURRENT_DATE, INTERVAL 365 DAY), 'SCHEDULED');
SELECT * FROM payment;
